function main()
    ...
    cross1 = Cross(5, 0.3, [-7 9 0], [0 0 0], 1, 'left');
    cross2 = Cross(5, 0.3, [-1 -2 0], [0 0 0], 1, 'right');
    cross3 = Cross(5, 0.3, [7 9 0], [0 0 0], 1, 'left');
    dt = 0.02;
    TT = 30;
    model = Construction();
    ...
    for t=0:dt:TT
        ...
        model.move(dt);
        model.draw();
        primeCircleCoords = model.construction{1}.cor(1:2) + model.construction{1}.U(1:2);
        primeCircleRad = model.construction{1}.rad;
        ...
        cross1.spinCross(dt);
         ...
         colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross1.a, cross1.b, cross1.cor, cross1.U);
         colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross1.b, cross1.a, cross1.cor, cross1.U);
         cross2.spinCross(dt);
         for j=1:3
         ...
         colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross2.a, cross2.b, cross2.cor, cross2.U);
         colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross2.b, cross2.a, cross2.cor, cross2.U);
         cross3.spinCross(dt);
         for j=1:3
          ...
          colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross3.a, cross3.b, cross3.cor, cross3.U);
          colDetect.detectCircleCollision(primeCircleCoords(1), primeCircleCoords(2), primeCircleRad, cross3.b, cross3.a, cross3.cor, cross3.U);      
        title(sprintf('t=%g',t));
        pause(dt); 
    end
