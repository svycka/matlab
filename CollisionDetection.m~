classdef CollisionDetection
    ...
    methods        
         ...
         function detectTriangleCollision(this, cor1, a1, b1, cor2, a2, b2, U2)
            ...
            colides(4) = this.detectLineCollision(pa1, pc1, pa2, pb2);
            colides(5) = this.detectLineCollision(pa1, pc1, pa2, pc2);
            colides(6) = this.detectLineCollision(pa1, pc1, pb2, pc2);
            ...
            colides(10) = this.detectLineCollision(pb1, pd1, pa2, pb2);
            colides(11) = this.detectLineCollision(pb1, pd1, pa2, pc2);
            colides(12) = this.detectLineCollision(pb1, pd1, pb2, pc2);
